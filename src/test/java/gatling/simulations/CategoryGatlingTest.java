            ...
            exec(
                ...
                .exec(
                    http("Create new category")
                        ...
                        .headers(headers_http_authenticated)
                        .body(StringBody("{" + "\"name\": \"SAMPLE_TEXT\"" + ", \"type\": \"SAMPLE_TEXT\"" + "}"))
                        .asJson()
                        .check(status().is(201))
                ...
                .repeat(5)
                .on(
                    exec(http("Get created category").get("/services/category${new_category_url}").headers(headers_http_authenticated))
                        .pause(10)
                )
                .exec(http("Delete created category").delete("/services/category${new_category_url}").headers(headers_http_authenticated))
                .pause(10)
        );
